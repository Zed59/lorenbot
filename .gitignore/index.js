...
client.on("message", async message => {
  ...
  if(command === "kick") {
    ...
    if(!member.kickable) 
      return message.reply("I cannot kick this user! Do they have a higher role? Do I have kck permissions?i");
  ...
  if(command === "ban") {
    ...
    if(!member)
      return message.reply("Merci de mentionner un membre valide de ce serveur");
    if(!member.bannable) 
      return message.reply("Tu veux ban ton maitre ?");
