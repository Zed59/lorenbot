...
client.on("ready", () => {
  ...
  client.user.setActivity(`vec le zgeg de nordine`);
});
...
client.on("message", async message => {
  ...
  if (command === "say") {
    ...
    const sayMessage = ("Bonjour, je m'appelle Lorenzob et je serais un futur bot utilitaire avec énormément de commandes utiles et pratique pour votre serveur. Actuellement mon propriétaire et entrain de me coder pour atteindre mon objectif final.");
  ...
  if (command === "clear") {
    ...
    if (!deleteCount || deleteCount < 1 || deleteCount > 100)
      return message.reply("Veuillez indiquer un nombre compris entre 1 et 100 pour le nombre de messages à supprimer.");
